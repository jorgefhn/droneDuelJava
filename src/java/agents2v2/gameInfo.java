...
public class gameInfo implements JsonObject{
	...
	public void init() {
		...
		this.drone3 = new droneInfo();
		this.drone4 = new droneInfo();
	...
	public String toString() {
		return "Game Info: drone1=" + drone1 + ", drone2=" + drone2+  "drone3=" + drone3 +  "drone4=" + drone4 +" Health Packages: "+healthPackages + " Ammo Packages: "+ammoPackages + " Charge Packages: "+chargePackages;
	}
